# AGENTS.md — `deeds_labs/services/archived-dead-files/cache`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-15T03:29:31.367Z · agents.md spec · regen: npm run agents:write -->

> Directory: deeds_labs/services/archived-dead-files/cache
...
- `CachePerformanceMonitor.svelte`
- `Enhanced3DEvidenceBoard.svelte`
- `multi-layer-cache.ts`
- `MultiLayerCacheSystem.ts`
- `semantic-cache.ts`
- `ssr-legal-api-cache.ts`
- `stack-cache.ts`
...
- **[LOW]** [TODO] `Enhanced3DEvidenceBoard.svelte`: TODO
...
- `wiki_note_lookup({ query: "archived-dead-files cache", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "deeds_labs/services/archived-dead-files/cache/<file>" })` — fetch any file's contents (sandboxed to src/)
