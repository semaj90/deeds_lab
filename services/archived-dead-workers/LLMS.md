# AGENTS.md — `deeds_labs/services/archived-dead-workers`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-15T03:29:31.367Z · agents.md spec · regen: npm run agents:write -->

> Directory: deeds_labs/services/archived-dead-workers

## Snapshot

- 6 file(s), 0 handler(s)
- Audit score: _(no GPU audit)_
- 🟠 hardcoded localhost: 1 · TODOs: 20


## Files (6)

- `ai-service-worker.ts`
- `aiProcessingWorker.js`
- `embedding-worker-enhanced.ts`
- `kmeans-worker.js`
- `transformersEmbeddingWorker.ts`
- `vector-computation-worker.js`
...
- **[LOW]** [TODO] `aiProcessingWorker.js`: TODO
- **[LOW]** [TODO] `aiProcessingWorker.js`: TODO
- **[LOW]** [TODO] `aiProcessingWorker.js`: TODO
- **[LOW]** [TODO] `aiProcessingWorker.js`: TODO
- **[LOW]** [TODO] `aiProcessingWorker.js`: TODO
...
- `graph_search({ query: "archived-dead-workers", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "services archived-dead-workers", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "deeds_labs/services/archived-dead-workers/<file>" })` — fetch any file's contents (sandboxed to src/)
