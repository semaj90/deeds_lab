# AGENTS.md — `deeds_labs/services/ts-consolidation-archive/vector`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-15T03:29:31.367Z · agents.md spec · regen: npm run agents:write -->

> Directory: deeds_labs/services/ts-consolidation-archive/vector
...
- `wiki_note_lookup({ query: "ts-consolidation-archive vector", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "deeds_labs/services/ts-consolidation-archive/vector/<file>" })` — fetch any file's contents (sandboxed to src/)
