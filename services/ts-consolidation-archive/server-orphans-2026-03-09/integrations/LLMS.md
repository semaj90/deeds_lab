# AGENTS.md — `deeds_labs/services/ts-consolidation-archive/server-orphans-2026-03-09/integrations`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-15T03:29:31.367Z · agents.md spec · regen: npm run agents:write -->

> Directory: deeds_labs/services/ts-consolidation-archive/server-orphans-2026-03-09/integrations
...
- **Paired tests**: 2/3 files have paired tests
...
- `wiki_note_lookup({ query: "server-orphans-2026-03-09 integrations", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "deeds_labs/services/ts-consolidation-archive/server-orphans-2026-03-09/integrations/<file>" })` — fetch any file's contents (sandboxed to src/)
