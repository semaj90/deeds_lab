# AGENTS.md — `deeds_labs/archived-dead-code/dead-lib-dirs/ui`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-15T03:29:31.367Z · agents.md spec · regen: npm run agents:write -->

> Directory: deeds_labs/archived-dead-code/dead-lib-dirs/ui

## Snapshot

- 46 file(s), 0 handler(s)
...
- **Paired tests**: 2/46 files have paired tests
...
- `wiki_note_lookup({ query: "dead-lib-dirs ui", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "deeds_labs/archived-dead-code/dead-lib-dirs/ui/<file>" })` — fetch any file's contents (sandboxed to src/)
