# LLMS.md — `deeds_labs/lib-dead-directories/storage/storage`
...
> Directory: deeds_labs/lib-dead-directories/storage/storage
...
- `read_file({ filePath: "deeds_labs/lib-dead-directories/storage/storage/<file>" })`
- `verify_fix({ filePath: "deeds_labs/lib-dead-directories/storage/storage/+server.ts" })`
