# LLMS.md — `deeds_labs/lib-dead-directories/performance`
...
> Directory: deeds_labs/lib-dead-directories/performance
...
- `read_file({ filePath: "deeds_labs/lib-dead-directories/performance/<file>" })`
- `verify_fix({ filePath: "deeds_labs/lib-dead-directories/performance/+server.ts" })`
