# AGENTS.md — `deeds_labs/routes-parked-full/api/routes/metadata`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-15T03:29:31.367Z · agents.md spec · regen: npm run agents:write -->

> Directory: deeds_labs/routes-parked-full/api/routes/metadata
...
- `read_file({ filePath: "deeds_labs/routes-parked-full/api/routes/metadata/<file>" })` — fetch any file's contents (sandboxed to src/)

For route handlers in this dir, also try:
- `verify_fix({ filePath: "deeds_labs/routes-parked-full/api/routes/metadata/+server.ts" })` — runs svelte-check / tsc on a single file
