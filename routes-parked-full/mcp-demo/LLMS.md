# LLMS.md — `deeds_labs/routes-parked-full/mcp-demo`
...
> Directory: deeds_labs/routes-parked-full/mcp-demo
...
- `read_file({ filePath: "deeds_labs/routes-parked-full/mcp-demo/<file>" })`
- `verify_fix({ filePath: "deeds_labs/routes-parked-full/mcp-demo/+server.ts" })`
