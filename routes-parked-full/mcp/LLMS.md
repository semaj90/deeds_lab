# LLMS.md — `deeds_labs/routes-parked-full/mcp`
...
> Directory: deeds_labs/routes-parked-full/mcp
...
- `read_file({ filePath: "deeds_labs/routes-parked-full/mcp/<file>" })`
- `verify_fix({ filePath: "deeds_labs/routes-parked-full/mcp/+server.ts" })`
