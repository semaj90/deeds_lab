# LLMS.md — `deeds_labs/routes-parked-full/auth/logout`
...
> Directory: deeds_labs/routes-parked-full/auth/logout
...
- `read_file({ filePath: "deeds_labs/routes-parked-full/auth/logout/<file>" })`
- `verify_fix({ filePath: "deeds_labs/routes-parked-full/auth/logout/+server.ts" })`
