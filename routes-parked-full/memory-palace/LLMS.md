# LLMS.md — `deeds_labs/routes-parked-full/memory-palace`
...
> Directory: deeds_labs/routes-parked-full/memory-palace
...
- `read_file({ filePath: "deeds_labs/routes-parked-full/memory-palace/<file>" })`
- `verify_fix({ filePath: "deeds_labs/routes-parked-full/memory-palace/+server.ts" })`
