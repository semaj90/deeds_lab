# LLMS.md — `deeds_labs/routes-parked-full/nier-showcase`
...
> Directory: deeds_labs/routes-parked-full/nier-showcase
...
- `read_file({ filePath: "deeds_labs/routes-parked-full/nier-showcase/<file>" })`
- `verify_fix({ filePath: "deeds_labs/routes-parked-full/nier-showcase/+server.ts" })`
