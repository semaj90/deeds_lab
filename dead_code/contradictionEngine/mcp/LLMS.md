# LLMS.md — `deeds_labs/dead_code/contradictionEngine/mcp`
...
> Directory: deeds_labs/dead_code/contradictionEngine/mcp
...
- `read_file({ filePath: "deeds_labs/dead_code/contradictionEngine/mcp/<file>" })`
- `verify_fix({ filePath: "deeds_labs/dead_code/contradictionEngine/mcp/+server.ts" })`
