# LLMS.md — `deeds_labs/dead_code/src-lib/validation`
...
> Directory: deeds_labs/dead_code/src-lib/validation
...
- `read_file({ filePath: "deeds_labs/dead_code/src-lib/validation/<file>" })`
- `verify_fix({ filePath: "deeds_labs/dead_code/src-lib/validation/+server.ts" })`
