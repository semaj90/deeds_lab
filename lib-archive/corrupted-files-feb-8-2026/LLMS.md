# AGENTS.md — `deeds_labs/lib-archive/corrupted-files-feb-8-2026`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-15T03:29:31.367Z · agents.md spec · regen: npm run agents:write -->

> Directory: deeds_labs/lib-archive/corrupted-files-feb-8-2026
...
- `aiAssistantMachine-machines.ts`
- `aiAssistantMachine-workflows.ts`
- `cached-rag-service.ts`
- `enhanced-case-api.ts`
- `legal-performance-metrics.ts`
- `multi-dimensional-image-cache.ts`
- `pgvector-utils.ts`
...
- `graph_search({ query: "corrupted-files-feb-8-2026", topK: 8 })` — files in this dir with tags, TODOs, audit flags
- `wiki_note_lookup({ query: "lib-archive corrupted-files-feb-8-2026", limit: 5 })` — KAG narrative + audit score
- `audit_hotspots({ limit: 10 })` — if this dir is failing gates, surfaces the broader hotspot set
- `read_file({ filePath: "deeds_labs/lib-archive/corrupted-files-feb-8-2026/<file>" })` — fetch any file's contents (sandboxed to src/)
