# LLMS.md — `deeds_labs/api-legacy/api/errors/stream`
...
> Directory: deeds_labs/api-legacy/api/errors/stream
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/errors/stream/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/errors/stream/+server.ts" })`
