# LLMS.md — `deeds_labs/api-legacy/api/attention`
...
> Directory: deeds_labs/api-legacy/api/attention
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/attention/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/attention/+server.ts" })`
