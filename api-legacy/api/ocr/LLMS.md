# LLMS.md — `deeds_labs/api-legacy/api/ocr`
...
> Directory: deeds_labs/api-legacy/api/ocr
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/ocr/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/ocr/+server.ts" })`
