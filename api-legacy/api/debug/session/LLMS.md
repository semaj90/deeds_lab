# LLMS.md — `deeds_labs/api-legacy/api/debug/session`
...
> Directory: deeds_labs/api-legacy/api/debug/session
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/debug/session/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/debug/session/+server.ts" })`
