# LLMS.md — `deeds_labs/api-legacy/api/laws/[code]`
...
> Directory: deeds_labs/api-legacy/api/laws/[code]
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/laws/[code]/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/laws/[code]/+server.ts" })`
