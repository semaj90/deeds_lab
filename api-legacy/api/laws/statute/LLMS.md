# LLMS.md — `deeds_labs/api-legacy/api/laws/statute`
...
> Directory: deeds_labs/api-legacy/api/laws/statute
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/laws/statute/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/laws/statute/+server.ts" })`
