# LLMS.md — `deeds_labs/api-legacy/api/predictor`
...
> Directory: deeds_labs/api-legacy/api/predictor
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/predictor/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/predictor/+server.ts" })`
