# LLMS.md — `deeds_labs/api-legacy/api/bits-ui/data`
...
> Directory: deeds_labs/api-legacy/api/bits-ui/data
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/bits-ui/data/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/bits-ui/data/+server.ts" })`
