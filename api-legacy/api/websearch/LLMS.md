# LLMS.md — `deeds_labs/api-legacy/api/websearch`
...
> Directory: deeds_labs/api-legacy/api/websearch
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/websearch/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/websearch/+server.ts" })`
