# LLMS.md — `deeds_labs/api-legacy/api/vector/status`
...
> Directory: deeds_labs/api-legacy/api/vector/status
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/vector/status/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/vector/status/+server.ts" })`
