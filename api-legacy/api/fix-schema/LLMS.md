# LLMS.md — `deeds_labs/api-legacy/api/fix-schema`
...
> Directory: deeds_labs/api-legacy/api/fix-schema
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/fix-schema/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/fix-schema/+server.ts" })`
