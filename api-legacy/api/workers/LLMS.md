# LLMS.md — `deeds_labs/api-legacy/api/workers`
...
> Directory: deeds_labs/api-legacy/api/workers
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/workers/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/workers/+server.ts" })`
