# LLMS.md — `deeds_labs/api-legacy/api/rag/query`
...
> Directory: deeds_labs/api-legacy/api/rag/query
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/rag/query/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/rag/query/+server.ts" })`
