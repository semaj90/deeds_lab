# LLMS.md — `deeds_labs/api-legacy/api/rag`
...
> Directory: deeds_labs/api-legacy/api/rag
...
- `archived-handlers.ts`
- `archived-handlers.ts`

## Agentic tool-calling — quick ACE hits

- `read_file({ filePath: "deeds_labs/api-legacy/api/rag/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/rag/+server.ts" })`
