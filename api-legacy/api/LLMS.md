# LLMS.md — `deeds_labs/api-legacy/api`
...
> Directory: deeds_labs/api-legacy/api
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/+server.ts" })`
