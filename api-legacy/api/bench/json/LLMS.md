# LLMS.md — `deeds_labs/api-legacy/api/bench/json`
...
> Directory: deeds_labs/api-legacy/api/bench/json
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/bench/json/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/bench/json/+server.ts" })`
