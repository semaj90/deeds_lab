# LLMS.md — `deeds_labs/api-legacy/api/persons`
...
> Directory: deeds_labs/api-legacy/api/persons
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/persons/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/persons/+server.ts" })`
