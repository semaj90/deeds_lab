# LLMS.md — `deeds_labs/api-legacy/api/persons/new`
...
> Directory: deeds_labs/api-legacy/api/persons/new
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/persons/new/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/persons/new/+server.ts" })`
