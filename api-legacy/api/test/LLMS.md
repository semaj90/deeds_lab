# LLMS.md — `deeds_labs/api-legacy/api/test`
...
> Directory: deeds_labs/api-legacy/api/test
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/test/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/test/+server.ts" })`
