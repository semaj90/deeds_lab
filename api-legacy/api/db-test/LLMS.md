# LLMS.md — `deeds_labs/api-legacy/api/db-test`
...
> Directory: deeds_labs/api-legacy/api/db-test
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/db-test/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/db-test/+server.ts" })`
