# LLMS.md — `deeds_labs/api-legacy/api/v1/upload`
...
> Directory: deeds_labs/api-legacy/api/v1/upload
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/v1/upload/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/v1/upload/+server.ts" })`
