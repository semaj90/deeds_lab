# LLMS.md — `deeds_labs/api-legacy/api/v1/startup`
...
> Directory: deeds_labs/api-legacy/api/v1/startup
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/v1/startup/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/v1/startup/+server.ts" })`
