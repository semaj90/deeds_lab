# LLMS.md — `deeds_labs/api-legacy/api/v1/evidence/vector`
...
> Directory: deeds_labs/api-legacy/api/v1/evidence/vector
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/v1/evidence/vector/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/v1/evidence/vector/+server.ts" })`
