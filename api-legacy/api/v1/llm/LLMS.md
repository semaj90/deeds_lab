# LLMS.md — `deeds_labs/api-legacy/api/v1/llm`
...
> Directory: deeds_labs/api-legacy/api/v1/llm
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/v1/llm/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/v1/llm/+server.ts" })`
