# LLMS.md — `deeds_labs/api-legacy/api/v1/legal/rag`
...
> Directory: deeds_labs/api-legacy/api/v1/legal/rag
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/v1/legal/rag/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/v1/legal/rag/+server.ts" })`
