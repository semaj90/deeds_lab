# LLMS.md — `deeds_labs/api-legacy/api/v1/storage/me`
...
> Directory: deeds_labs/api-legacy/api/v1/storage/me
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/v1/storage/me/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/v1/storage/me/+server.ts" })`
