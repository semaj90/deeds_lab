# LLMS.md — `deeds_labs/api-legacy/api/v1/xstate`
...
> Directory: deeds_labs/api-legacy/api/v1/xstate
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/v1/xstate/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/v1/xstate/+server.ts" })`
