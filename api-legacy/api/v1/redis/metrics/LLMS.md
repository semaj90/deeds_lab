# LLMS.md — `deeds_labs/api-legacy/api/v1/redis/metrics`
...
> Directory: deeds_labs/api-legacy/api/v1/redis/metrics
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/v1/redis/metrics/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/v1/redis/metrics/+server.ts" })`
