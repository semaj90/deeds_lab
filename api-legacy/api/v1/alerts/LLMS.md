# LLMS.md — `deeds_labs/api-legacy/api/v1/alerts`
...
> Directory: deeds_labs/api-legacy/api/v1/alerts
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/v1/alerts/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/v1/alerts/+server.ts" })`
