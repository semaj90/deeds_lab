# LLMS.md — `deeds_labs/api-legacy/api/v1/rag/cached`
...
> Directory: deeds_labs/api-legacy/api/v1/rag/cached
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/v1/rag/cached/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/v1/rag/cached/+server.ts" })`
