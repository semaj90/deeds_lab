# LLMS.md — `deeds_labs/api-legacy/api/v1/rag/search`
...
> Directory: deeds_labs/api-legacy/api/v1/rag/search
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/v1/rag/search/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/v1/rag/search/+server.ts" })`
