# LLMS.md — `deeds_labs/api-legacy/api/v1/rag/chat`
...
> Directory: deeds_labs/api-legacy/api/v1/rag/chat
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/v1/rag/chat/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/v1/rag/chat/+server.ts" })`
