# LLMS.md — `deeds_labs/api-legacy/api/v1/poi/photo`
...
> Directory: deeds_labs/api-legacy/api/v1/poi/photo
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/v1/poi/photo/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/v1/poi/photo/+server.ts" })`
