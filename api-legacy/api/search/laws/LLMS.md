# LLMS.md — `deeds_labs/api-legacy/api/search/laws`
...
> Directory: deeds_labs/api-legacy/api/search/laws
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/search/laws/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/search/laws/+server.ts" })`
