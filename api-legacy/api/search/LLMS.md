# LLMS.md — `deeds_labs/api-legacy/api/search`
...
> Directory: deeds_labs/api-legacy/api/search
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/search/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/search/+server.ts" })`
