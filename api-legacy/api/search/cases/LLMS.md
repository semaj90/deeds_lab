# LLMS.md — `deeds_labs/api-legacy/api/search/cases`
...
> Directory: deeds_labs/api-legacy/api/search/cases
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/search/cases/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/search/cases/+server.ts" })`
