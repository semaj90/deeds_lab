# LLMS.md — `deeds_labs/api-legacy/api/mcp/metrics`
...
> Directory: deeds_labs/api-legacy/api/mcp/metrics
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/mcp/metrics/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/mcp/metrics/+server.ts" })`
