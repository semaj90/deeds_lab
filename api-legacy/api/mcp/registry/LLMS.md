# LLMS.md — `deeds_labs/api-legacy/api/mcp/registry`
...
> Directory: deeds_labs/api-legacy/api/mcp/registry
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/mcp/registry/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/mcp/registry/+server.ts" })`
