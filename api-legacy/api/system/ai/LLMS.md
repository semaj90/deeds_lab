# LLMS.md — `deeds_labs/api-legacy/api/system/ai`
...
> Directory: deeds_labs/api-legacy/api/system/ai
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/system/ai/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/system/ai/+server.ts" })`
