# LLMS.md — `deeds_labs/api-legacy/api/system/vector`
...
> Directory: deeds_labs/api-legacy/api/system/vector
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/system/vector/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/system/vector/+server.ts" })`
