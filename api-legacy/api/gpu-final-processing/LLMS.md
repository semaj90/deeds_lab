# LLMS.md — `deeds_labs/api-legacy/api/gpu-final-processing`
...
> Directory: deeds_labs/api-legacy/api/gpu-final-processing
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/gpu-final-processing/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/gpu-final-processing/+server.ts" })`
