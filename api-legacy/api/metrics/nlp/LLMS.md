# LLMS.md — `deeds_labs/api-legacy/api/metrics/nlp`
...
> Directory: deeds_labs/api-legacy/api/metrics/nlp
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/metrics/nlp/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/metrics/nlp/+server.ts" })`
