# LLMS.md — `deeds_labs/api-legacy/api/document/[id]`
...
> Directory: deeds_labs/api-legacy/api/document/[id]
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/document/[id]/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/document/[id]/+server.ts" })`
