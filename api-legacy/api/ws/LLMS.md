# LLMS.md — `deeds_labs/api-legacy/api/ws`
...
> Directory: deeds_labs/api-legacy/api/ws
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/ws/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/ws/+server.ts" })`
