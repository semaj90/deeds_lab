# LLMS.md — `deeds_labs/api-legacy/api/poi/create`
...
> Directory: deeds_labs/api-legacy/api/poi/create
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/poi/create/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/poi/create/+server.ts" })`
