# LLMS.md — `deeds_labs/api-legacy/api/ai/legal-bert`
...
> Directory: deeds_labs/api-legacy/api/ai/legal-bert
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/ai/legal-bert/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/ai/legal-bert/+server.ts" })`
