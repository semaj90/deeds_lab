# LLMS.md — `deeds_labs/api-legacy/api/ai/upload`
...
> Directory: deeds_labs/api-legacy/api/ai/upload
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/ai/upload/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/ai/upload/+server.ts" })`
