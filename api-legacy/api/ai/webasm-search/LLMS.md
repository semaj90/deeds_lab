# LLMS.md — `deeds_labs/api-legacy/api/ai/webasm-search`
...
> Directory: deeds_labs/api-legacy/api/ai/webasm-search
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/ai/webasm-search/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/ai/webasm-search/+server.ts" })`
