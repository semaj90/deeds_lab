# LLMS.md — `deeds_labs/api-legacy/api/ai/load-model`
...
> Directory: deeds_labs/api-legacy/api/ai/load-model
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/ai/load-model/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/ai/load-model/+server.ts" })`
