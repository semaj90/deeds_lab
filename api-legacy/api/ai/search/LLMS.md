# LLMS.md — `deeds_labs/api-legacy/api/ai/search`
...
> Directory: deeds_labs/api-legacy/api/ai/search
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/ai/search/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/ai/search/+server.ts" })`
