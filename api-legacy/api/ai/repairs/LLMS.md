# LLMS.md — `deeds_labs/api-legacy/api/ai/repairs`
...
> Directory: deeds_labs/api-legacy/api/ai/repairs
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/ai/repairs/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/ai/repairs/+server.ts" })`
