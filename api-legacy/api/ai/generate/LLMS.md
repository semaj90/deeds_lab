# LLMS.md — `deeds_labs/api-legacy/api/ai/generate`
...
> Directory: deeds_labs/api-legacy/api/ai/generate
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/ai/generate/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/ai/generate/+server.ts" })`
