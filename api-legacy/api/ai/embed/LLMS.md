# LLMS.md — `deeds_labs/api-legacy/api/ai/embed`
...
> Directory: deeds_labs/api-legacy/api/ai/embed
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/ai/embed/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/ai/embed/+server.ts" })`
