# LLMS.md — `deeds_labs/api-legacy/api/ai/context`
...
> Directory: deeds_labs/api-legacy/api/ai/context
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/ai/context/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/ai/context/+server.ts" })`
