# LLMS.md — `deeds_labs/api-legacy/api/canvas`
...
> Directory: deeds_labs/api-legacy/api/canvas
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/canvas/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/canvas/+server.ts" })`
