# LLMS.md — `deeds_labs/api-legacy/api/analytics`
...
> Directory: deeds_labs/api-legacy/api/analytics
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/analytics/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/analytics/+server.ts" })`
