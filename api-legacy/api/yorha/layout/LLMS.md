# LLMS.md — `deeds_labs/api-legacy/api/yorha/layout`
...
> Directory: deeds_labs/api-legacy/api/yorha/layout
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/yorha/layout/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/yorha/layout/+server.ts" })`
