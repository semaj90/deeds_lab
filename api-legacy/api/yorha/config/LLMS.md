# LLMS.md — `deeds_labs/api-legacy/api/yorha/config`
...
> Directory: deeds_labs/api-legacy/api/yorha/config
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/yorha/config/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/yorha/config/+server.ts" })`
