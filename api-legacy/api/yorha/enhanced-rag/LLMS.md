# LLMS.md — `deeds_labs/api-legacy/api/yorha/enhanced-rag`
...
> Directory: deeds_labs/api-legacy/api/yorha/enhanced-rag
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/yorha/enhanced-rag/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/yorha/enhanced-rag/+server.ts" })`
