# LLMS.md — `deeds_labs/api-legacy/api/graph`
...
> Directory: deeds_labs/api-legacy/api/graph
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/graph/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/graph/+server.ts" })`
