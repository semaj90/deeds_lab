# LLMS.md — `deeds_labs/api-legacy/api/graph/search`
...
> Directory: deeds_labs/api-legacy/api/graph/search
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/graph/search/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/graph/search/+server.ts" })`
