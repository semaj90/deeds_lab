# LLMS.md — `deeds_labs/api-legacy/api/graph/compare`
...
> Directory: deeds_labs/api-legacy/api/graph/compare
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/graph/compare/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/graph/compare/+server.ts" })`
