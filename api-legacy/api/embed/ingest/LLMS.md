# LLMS.md — `deeds_labs/api-legacy/api/embed/ingest`
...
> Directory: deeds_labs/api-legacy/api/embed/ingest
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/embed/ingest/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/embed/ingest/+server.ts" })`
