# LLMS.md — `deeds_labs/api-legacy/api/embed`
...
> Directory: deeds_labs/api-legacy/api/embed
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/embed/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/embed/+server.ts" })`
