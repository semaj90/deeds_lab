# LLMS.md — `deeds_labs/api-legacy/api/legal/search`
...
> Directory: deeds_labs/api-legacy/api/legal/search
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/legal/search/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/legal/search/+server.ts" })`
