# LLMS.md — `deeds_labs/api-legacy/api/ollama/chat`
...
> Directory: deeds_labs/api-legacy/api/ollama/chat
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/ollama/chat/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/ollama/chat/+server.ts" })`
