# LLMS.md — `deeds_labs/api-legacy/api/ollama/pull`
...
> Directory: deeds_labs/api-legacy/api/ollama/pull
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/ollama/pull/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/ollama/pull/+server.ts" })`
