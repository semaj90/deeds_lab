# LLMS.md — `deeds_labs/api-legacy/api/ollama/embed`
...
> Directory: deeds_labs/api-legacy/api/ollama/embed
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/ollama/embed/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/ollama/embed/+server.ts" })`
