# LLMS.md — `deeds_labs/api-legacy/api/wasm/metrics`
...
> Directory: deeds_labs/api-legacy/api/wasm/metrics
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/wasm/metrics/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/wasm/metrics/+server.ts" })`
