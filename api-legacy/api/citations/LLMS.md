# LLMS.md — `deeds_labs/api-legacy/api/citations`
...
> Directory: deeds_labs/api-legacy/api/citations
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/citations/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/citations/+server.ts" })`
