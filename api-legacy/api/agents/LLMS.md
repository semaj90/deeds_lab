# LLMS.md — `deeds_labs/api-legacy/api/agents`
...
> Directory: deeds_labs/api-legacy/api/agents
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/agents/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/agents/+server.ts" })`
