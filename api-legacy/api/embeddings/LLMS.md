# LLMS.md — `deeds_labs/api-legacy/api/embeddings`
...
> Directory: deeds_labs/api-legacy/api/embeddings
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/embeddings/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/embeddings/+server.ts" })`
