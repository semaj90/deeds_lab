# LLMS.md — `deeds_labs/api-legacy/api/docling`
...
> Directory: deeds_labs/api-legacy/api/docling
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/docling/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/docling/+server.ts" })`
