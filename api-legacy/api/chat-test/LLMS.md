# LLMS.md — `deeds_labs/api-legacy/api/chat-test`
...
> Directory: deeds_labs/api-legacy/api/chat-test
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/chat-test/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/chat-test/+server.ts" })`
