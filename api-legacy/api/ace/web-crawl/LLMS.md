# LLMS.md — `deeds_labs/api-legacy/api/ace/web-crawl`
...
> Directory: deeds_labs/api-legacy/api/ace/web-crawl
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/ace/web-crawl/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/ace/web-crawl/+server.ts" })`
