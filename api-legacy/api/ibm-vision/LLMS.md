# LLMS.md — `deeds_labs/api-legacy/api/ibm-vision`
...
> Directory: deeds_labs/api-legacy/api/ibm-vision
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/ibm-vision/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/ibm-vision/+server.ts" })`
