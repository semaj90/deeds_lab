# LLMS.md — `deeds_labs/api-legacy/api/summarize`
...
> Directory: deeds_labs/api-legacy/api/summarize
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/summarize/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/summarize/+server.ts" })`
