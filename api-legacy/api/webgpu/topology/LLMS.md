# LLMS.md — `deeds_labs/api-legacy/api/webgpu/topology`
...
> Directory: deeds_labs/api-legacy/api/webgpu/topology
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/webgpu/topology/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/webgpu/topology/+server.ts" })`
