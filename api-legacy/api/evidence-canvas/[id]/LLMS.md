# LLMS.md — `deeds_labs/api-legacy/api/evidence-canvas/[id]`
...
> Directory: deeds_labs/api-legacy/api/evidence-canvas/[id]
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/evidence-canvas/[id]/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/evidence-canvas/[id]/+server.ts" })`
