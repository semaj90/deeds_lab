# LLMS.md — `deeds_labs/api-legacy/api/database-test`
...
> Directory: deeds_labs/api-legacy/api/database-test
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/database-test/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/database-test/+server.ts" })`
