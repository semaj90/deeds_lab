# LLMS.md — `deeds_labs/api-legacy/api/cases/summary`
...
> Directory: deeds_labs/api-legacy/api/cases/summary
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/cases/summary/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/cases/summary/+server.ts" })`
