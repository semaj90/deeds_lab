# LLMS.md — `deeds_labs/api-legacy/api/cases/[id]/laws`
...
> Directory: deeds_labs/api-legacy/api/cases/[id]/laws
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/cases/[id]/laws/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/cases/[id]/laws/+server.ts" })`
