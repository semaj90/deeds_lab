# LLMS.md — `deeds_labs/api-legacy/api/cases/[id]`
...
> Directory: deeds_labs/api-legacy/api/cases/[id]
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/cases/[id]/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/cases/[id]/+server.ts" })`
