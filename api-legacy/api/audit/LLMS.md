# LLMS.md — `deeds_labs/api-legacy/api/audit`
...
> Directory: deeds_labs/api-legacy/api/audit
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/audit/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/audit/+server.ts" })`
