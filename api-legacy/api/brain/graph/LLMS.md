# LLMS.md — `deeds_labs/api-legacy/api/brain/graph`
...
> Directory: deeds_labs/api-legacy/api/brain/graph
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/brain/graph/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/brain/graph/+server.ts" })`
