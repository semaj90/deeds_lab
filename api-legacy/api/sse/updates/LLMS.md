# LLMS.md — `deeds_labs/api-legacy/api/sse/updates`
...
> Directory: deeds_labs/api-legacy/api/sse/updates
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/sse/updates/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/sse/updates/+server.ts" })`
