# LLMS.md — `deeds_labs/api-legacy/api/sse/workflows`
...
> Directory: deeds_labs/api-legacy/api/sse/workflows
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/sse/workflows/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/sse/workflows/+server.ts" })`
