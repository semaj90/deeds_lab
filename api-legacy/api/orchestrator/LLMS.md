# LLMS.md — `deeds_labs/api-legacy/api/orchestrator`
...
> Directory: deeds_labs/api-legacy/api/orchestrator
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/orchestrator/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/orchestrator/+server.ts" })`
