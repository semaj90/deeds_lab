# LLMS.md — `deeds_labs/api-legacy/api/routes`
...
> Directory: deeds_labs/api-legacy/api/routes
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/routes/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/routes/+server.ts" })`
