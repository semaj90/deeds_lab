# LLMS.md — `deeds_labs/api-legacy/api/routes/ws`
...
> Directory: deeds_labs/api-legacy/api/routes/ws
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/routes/ws/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/routes/ws/+server.ts" })`
