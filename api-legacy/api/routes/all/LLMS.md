# LLMS.md — `deeds_labs/api-legacy/api/routes/all`
...
> Directory: deeds_labs/api-legacy/api/routes/all
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/routes/all/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/routes/all/+server.ts" })`
