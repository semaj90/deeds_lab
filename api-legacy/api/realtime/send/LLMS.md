# LLMS.md — `deeds_labs/api-legacy/api/realtime/send`
...
> Directory: deeds_labs/api-legacy/api/realtime/send
...
- `read_file({ filePath: "deeds_labs/api-legacy/api/realtime/send/<file>" })`
- `verify_fix({ filePath: "deeds_labs/api-legacy/api/realtime/send/+server.ts" })`
