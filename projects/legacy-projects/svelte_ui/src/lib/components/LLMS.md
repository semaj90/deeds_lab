# AGENTS.md — `deeds_labs/projects/legacy-projects/svelte_ui/src/lib/components`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-15T03:29:31.367Z · agents.md spec · regen: npm run agents:write -->

> Directory: deeds_labs/projects/legacy-projects/svelte_ui/src/lib/components
...
| Gate | Status | Detail |
|------|--------|--------|
| G21-24 | ❌ FAIL | 4/4 files with Svelte 4 patterns |
| G20 | ✅ PASS | clean ✅ |

_Gates checked: G21-24, G20. Run `npm run index:codebase:fast && npm run agents:write` to refresh._
## Todos + Enhancements

- **[HIGH]** [G21-24] Fix **G21-24** Svelte 5 rune compliance: 4/4 files with Svelte 4 patterns
...
- `read_file({ filePath: "deeds_labs/projects/legacy-projects/svelte_ui/src/lib/components/<file>" })` — fetch any file's contents (sandboxed to src/)
