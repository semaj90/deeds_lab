...
Package: `github.com/sehwan505/langextract-go/cmd/langextract/internal/config`

```go
package config // import "github.com/sehwan505/langextract-go/cmd/langextract/internal/config"
...
func LoadGlobalConfig() (*GlobalConfig, error)
    LoadGlobalConfig loads configuration from multiple sources in order of
    precedence: 1. Command line flags (highest priority) 2. Environment
    variables 3. Configuration file 4. Default values (lowest priority)
