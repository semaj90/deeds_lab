# AGENTS.md — `deeds_labs/projects/legacy-projects/src/lib/gpu`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-15T03:29:31.367Z · agents.md spec · regen: npm run agents:write -->

> Directory: deeds_labs/projects/legacy-projects/src/lib/gpu
...
- `vertex-cache-manager.ts`
- `visual-memory-palace-integration.ts`
- `webgpu-vertex-streamer.ts`
...
- `read_file({ filePath: "deeds_labs/projects/legacy-projects/src/lib/gpu/<file>" })` — fetch any file's contents (sandboxed to src/)
