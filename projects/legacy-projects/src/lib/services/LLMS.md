# AGENTS.md — `deeds_labs/projects/legacy-projects/src/lib/services`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-15T03:29:31.367Z · agents.md spec · regen: npm run agents:write -->

> Directory: deeds_labs/projects/legacy-projects/src/lib/services

## Snapshot

- 23 file(s), 0 handler(s)
- Audit score: _(no GPU audit)_
- 🟠 hardcoded localhost: 6


## Files (23)

- `cross-encoder-reranker.ts`
- `determinism-evaluation-service.ts`
- `document-ingestion-service.ts`
- `document-processor.ts`
- `existing-services-orchestrator.ts`
- `gemma-embedding-service.ts`
- `kmeans-clustering.ts`
- `legal-ai-orchestrator.ts`
...
| Gate | Status | Detail |
|------|--------|--------|
| G17 | ❌ FAIL | 6/23 files — use env.server.ts getters |

_Gates checked: G17. Run `npm run index:codebase:fast && npm run agents:write` to refresh._
## Todos + Enhancements

- **[HIGH]** [G17] Fix **G17** No hardcoded localhost URLs: 6/23 files — use env.server.ts getters
...
- **Paired tests**: 0/23 files have paired tests
...
- `read_file({ filePath: "deeds_labs/projects/legacy-projects/src/lib/services/<file>" })` — fetch any file's contents (sandboxed to src/)
