# AGENTS.md — `deeds_labs/projects/legacy-projects/src/lib/workers`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-15T03:29:31.367Z · agents.md spec · regen: npm run agents:write -->

> Directory: deeds_labs/projects/legacy-projects/src/lib/workers
...
- `loki-store.ts`
- `recursive-evidence-chain-worker.ts`
- `webgpu-worker.ts`
- `worker-manager.js`
...
- `read_file({ filePath: "deeds_labs/projects/legacy-projects/src/lib/workers/<file>" })` — fetch any file's contents (sandboxed to src/)
