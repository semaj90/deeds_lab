# AGENTS.md — `deeds_labs/projects/legacy-projects/src/lib/components`

<!-- AGENTS-GEN v1 · do not edit below this line -->
<!-- generated: 2026-05-15T03:29:31.367Z · agents.md spec · regen: npm run agents:write -->

> Directory: deeds_labs/projects/legacy-projects/src/lib/components
...
- `AIChat.svelte`
- `AISummarization.svelte`
- `DocumentAnalysis.svelte`
- `DocumentUploader.svelte`
- `LegalChat.svelte`
- `VectorSearchInterface.svelte`
- `VectorSearchInterface_fixed.svelte`
...
- `read_file({ filePath: "deeds_labs/projects/legacy-projects/src/lib/components/<file>" })` — fetch any file's contents (sandboxed to src/)
