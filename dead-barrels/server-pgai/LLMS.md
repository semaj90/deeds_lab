# LLMS.md — `deeds_labs/dead-barrels/server-pgai`
...
> Directory: deeds_labs/dead-barrels/server-pgai
...
- `read_file({ filePath: "deeds_labs/dead-barrels/server-pgai/<file>" })`
- `verify_fix({ filePath: "deeds_labs/dead-barrels/server-pgai/+server.ts" })`
